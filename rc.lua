...
tags = {
   names  = { "∀", "ff", "mail", "im", "ecl", "6", "☣", "8", "☢" },
   layout = { layouts[3], layouts[8], layouts[8], layouts[2], layouts[8],
...
upicon.image = image("/home/michael/Bilder/dzen_bitmaps/arr_up.png")

downicon = widget({ type = "imagebox" })
downicon.image = image("/home/michael/Bilder/dzen_bitmaps/arr_down.png")
...
--Initialize widget
  ...
  batwidget:set_gradient_colors({ "#990000", "#00FF00", "#00FF00" })
  vicious.register(batwidget, vicious.widgets.bat, "$2", 61, "BAT0")
--Initialize widget

name = widget ({ type = "textbox" })
name.text = "Menzel   "

ram = widget ({ type = "textbox" })
ram.text = "RAM: "

keyboard = widget ({ type = "textbox" })
keyboard.text = " US " 

up = widget ({ type ="textbox" })
up.text = " up"

down = widget ({ type = "textbox" })
down.text = "down "
...
awful.key({ modkey, 		}, "s", function() awful.util.spawn("sudo shutdown 0") end),  
